...
<?php 
 $title = "Confirmed PIL Withdrawals"; 
 ?>
...
<!--<body class="hold-transition skin-red sidebar-mini">-->
  ...
  <div id="overlay" style="background-color: #ecf0f5;opacity: 0.5;z-index: 2000;position: absolute;left: 0;top: 0;width: 100%;height: 100%;display: none;">
    ...
    <section class="content-header" style="color:white;">
        <h1><b>
           Confirmed PIL Withdrawals
        </b></h1>
        <ol class="breadcrumb">
            <li><a href="dashboard" style="color:white;"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active" style="color:white;"><i class="fa fa-users"></i> Confirmed PIL Withdrawals</li>
        </ol>
   ...
   $cash_count = mysqli_num_rows($appinfo);
	...
	?>
        ...
        <div class="box-header with-border">
            <h3 class="box-title"><strong> Confirmed PIL Withdrawals  </h3>    <?php if( $return_count != 0 ) { ?>
                        Showing <?php echo $return_count; ?>  of <?php echo $return_count; ?> Confirmed PIL Withdrawals<?php if($return_count != 1) { ?>s<?php } ?>
                        <?php } else { ?>
                            0 Confirmed PIL Withdrawals
                        <?php } ?>
						</strong>

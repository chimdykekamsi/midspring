...
<?php
	$result14 = mysqli_query($con,"SELECT * FROM sub_package WHERE status='active'");
    ...
    <section class="content-header" style="color:white;">
        <h1><b>
            Active Package Accounts
        </b></h1>
        <ol class="breadcrumb">
            <li><a href="dashboard" style="color:white;"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active" style="color:white;"><i class="fa fa-users"></i> Active Package Accounts</li>
        </ol>
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><strong> Active Package Accounts     <?php if( $return_count != 0 ) { ?>
                        Showing <?php echo $return_count; ?>  of <?php echo $return_count; ?> Active Package Accounts<?php if($return_count != 1) { ?>s<?php } ?>
                        <?php } else { ?>
                            0 Active Package Accounts
                        <?php } ?>
						</strong>
                    </h3>
...
?>
	...
	<td> <b> <?php echo date("M D, Y H:m:s a",strtotime($row['incubate_date'])); ?> </b></td>

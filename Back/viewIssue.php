...
<?php 
 $title = "View Upline/Downline Issue"; 
 ?>
...
<!--<body class="hold-transition skin-red sidebar-mini">-->
  ...
  <div id="overlay" style="background-color: #ecf0f5;opacity: 0.5;z-index: 2000;position: absolute;left: 0;top: 0;width: 100%;height: 100%;display: none;">
    ...
    <section class="content-header">
        <h1><b>
            View Upline/Downline Issue
        </b></h1>
        <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><i class="fa fa-users"></i> View Upline/Downline Issue</li>
        </ol>
...
<?php	       
   $appinfo = mysqli_query($con, "select * from report");
			...
			<div class="box">
                <div class="row">
                    ...
                    <div class="col-sm-10 text-center lead">
                        Showing <?php echo $cash_count; ?> of <?php echo $cash_count; ?> Upline/Downline Issue
                    </div>
                    <div class="col-sm-2">
                    </div>
                </div>
...
?>					                               <tr>
                                ...
                                <td><?php echo $row['message']; ?></td>
								                                ...
								                                <td>                                            <a href="readContent?read=<?php echo $row['id']; ?>" class="btn btn-xs btn-success">Read</a>                                            <a href="deleteContent?delete=<?php echo $row['id']; ?>" class="btn btn-xs btn-danger">Delete</a>

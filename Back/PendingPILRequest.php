...
<!--<body class="hold-transition skin-red sidebar-mini">-->
  ...
  <div id="overlay" style="background-color: #ecf0f5;opacity: 0.5;z-index: 2000;position: absolute;left: 0;top: 0;width: 100%;height: 100%;display: none;">
    ...
    <section class="content-header" style="color:white;">
        <h1><b>
            Pending PIL Withdrawals
        </b></h1>
        <ol class="breadcrumb">
            <li><a href="dashboard" style="color:white;"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active" style="color:white;"><i class="fa fa-users"></i> Pending PIL Withdrawals</li>
        </ol>
   ...
   $cash_count = mysqli_num_rows($appinfo);
	...
	?>
        ...
        <div class="box-header with-border">
            <h3 class="box-title"><strong> Pending PIL Withdrawals  </h3>    <?php if( $return_count != 0 ) { ?>
                        Showing <?php echo $return_count; ?>  of <?php echo $return_count; ?> Pending PIL Withdrawals<?php if($return_count != 1) { ?>s<?php } ?>
                        <?php } else { ?>
                            0 Pending PIL Withdrawals
                        <?php } ?>
						</strong>

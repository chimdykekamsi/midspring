                    ...
                    <div class="card">
					    ...
					    <div class="card-body" style="padding-top:5px;padding-bottom:7px;border-top: 1px solid #ebedf2!important;">
					        ...
					        <div class="form-group col-md-5">
						        ...
						        <input type="text" maxlength="5" id="pin" name="pin" placeholder="pin" class="form-control" required="">
					        </div>
						...
						<div class="card-footer py-2" align="center">
						    <button class="btn btn-warning btn-sm" type="submit" name="trans">Transfer <i class="fa la-check-circle"></i></button>
						</div>
						</form>
						<?php 
							if(isset($_POST['trans'])){
								...
								// var_dump($post);
								echo wire_transfer($post, $session_id);
							}
						?>
					</div>
                </div>
...
</div><script src="assets/js/core/jquery.3.2.1.min.js"></script>
<script src="assets/js/core/popper.min.js"></script>
<script src="assets/js/core/bootstrap.min.js" defer></script>
<script src="assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js" defer>
</script><script src="assets/js/ready.min.js" defer></script>
